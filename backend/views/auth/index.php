            ...
            <div class="bg-dark p-4">
                ...
                <form action="" method="POST">
                    <div class="form-floating">
                        <input type="text" class="form-control bg-dark text-white rounded-bottom-0" id="username" name="username" placeholder=" ">
                        <label for="username" class="text-white">Username</label>
                        <div class="invalid-feedback">Please enter your username.</div>
                    </div>
                    <div class="mb-3 form-floating">
                        <input type="password" class="form-control bg-dark text-white rounded-top-0" id="password" name="password" placeholder=" ">
